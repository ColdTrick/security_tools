...
$upgrade_settings .= elgg_view('input/dropdown', [
	'name' => 'params[secure_upgrade]',
	'value' => $plugin->secure_upgrade,
...
$upgrade_settings .= elgg_format_element('pre', [], elgg_normalize_url('upgrade.php?code=' . ColdTrick\SecurityTools\Upgrade::generateCode()));
$upgrade_settings .= '</div>';

// Mail
$mail_settings = '<div>';
$mail_settings .= elgg_echo('security_tools:settings:mails_admin_admins');
$mail_settings .= elgg_view('input/dropdown', [
	'name' => 'params[mails_admin_admins]',
	'value' => $plugin->mails_admin_admins,
	'options_values' => $yesno_options,
	'class' => 'mls',
]);
...
$mail_settings .= elgg_view('input/dropdown', [
	'name' => 'params[mails_admin_user]',
	'value' => $plugin->mails_admin_user,
...
$mail_settings .= elgg_view('input/dropdown', [
	'name' => 'params[mails_password_change]',
	'value' => $plugin->mails_password_change,
	'options_values' => $yesno_options,
	'class' => 'mls',
]);
...
$mail_settings .= elgg_view('input/dropdown', [
	'name' => 'params[mails_banned]',
	'value' => $plugin->mails_banned,
	'options_values' => $noyes_options,
	'class' => 'mls',
]);
...
$mail_settings .= elgg_view('input/dropdown', [
	'name' => 'params[mails_verify_email_change]',
	'value' => $plugin->mails_verify_email_change,
	'options_values' => $yesno_options,
	'class' => 'mls',
]);
...
$other_settings .= elgg_view('input/dropdown', [
	'name' => 'params[disable_autocomplete_on_password_fields]',
	'value' => $plugin->disable_autocomplete_on_password_fields,
	'options_values' => $noyes_options,
	'class' => 'mls',
]);
