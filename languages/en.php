...
$english = array(
	...
	'security_tools:settings:secure_upgrade:bypass' => "Allow administrators to bypass upgrade keycode security",
	'security_tools:settings:secure_upgrade:bypass:description' => "When this is set to 'yes' an administrator can manualy trigger the upgrade by going to the currect URL without a keycode.",
